...
- `CB07442115` under `CCC`/`REN` (Liverpool/Ned) is a hand-picked synthetic MRN, not sourced from any CSV — `Input/V2/O01/Clatterbridge-Order.txt` and `Input/V2/R01/LUFT_ORU_For_Clatterbridge.txt` previously carried `X`-masked/redacted demographics with no usable NHS number, which the RIE rejected; they were de-anonymised to Liverpool/Ned (already the patient used in `Input/V2/R01/Clatterbridge-REN-ORU_R01.txt`) to keep one consistent Merseyside test patient across all three Clatterbridge fixtures. `notebooks/10-histocompatibility-immunogenetics-hl7v2-nw-standard.ipynb` reuses this same Liverpool/Ned identity for its hand-built `Clatterbridge-Order.txt` → NW-standard conversion (`Output/V2/O01/Clatterbridge-Order-NWstandard.txt`), and checks that conversion against `histotrac-MFT-chimerism.txt`'s Manchester/`R0A` patient and Liverpool/Ned-under-`REM` (`histotrac.txt`, MRN `REM7442130`) — no new patient/trust pair for either of those, so no table row changes for them. `histotrac-MFT-HLA.txt` (a different, HLA-antibody-screening order from the same Trust/pipeline — Clatterbridge's own orders to Histotrac are chimerism-only, so this file isn't part of that conversion check, just its own independent `IntegrationTest.py` fixture) keeps its existing Manchester/Sansa identity (NHS `973 738 3192`, MRN `R0A4990415` — already recorded in the `R0A` column above).
- `R0A1680914` under `R0A` (Wythenshawe/Lyanna, NHS `999 999 9638`) is a new synthetic patient for `Input/V2/O01/histotrac-MFT-chimerism.txt` — that file previously carried a real-looking MRN (`11680914`) with a placeholder `SURNAME^FIRSTNAME` name and no NHS number at all (PID-19 empty), which the live transform would have had nothing to assign an NHS number from. No existing NW Genomics test patient (`Input/PDS/NW.csv`) or NHS England EDI test patient is a child (this file's DOB, `2017-09-11`, is Royal Manchester Children's Hospital Paediatric Haematology's own), so this reuses the next unused, checksum-valid NHS number in the same EDI test block (`999 999 94xx`–`999 999 96xx`) already partly assigned elsewhere in this table, paired with a new Manchester-area place name/given name in this table's existing style rather than a fabricated non-EDI number.
...
| 999 999 9603 | Editestpatient | 300003 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | RK59690678 |  |  |  |  |  |  |  |  |  | RTR7734215 |  |  |  |  | RX14389121 |  |  |  |  |  |  |
...
| 999 999 9581 | Editestpatient | 300010 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | RK57256476 |  |  |  | RNN4482290 |  |  |  |  |  |  |  | RVR6796096 |  |  |  |  |  |  |  |  |  |
| 999 999 9514 | Editestpatient | 300011 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | RJE8170665 |  |  |  |  |  | RNN5591038 | RPY8254161 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
...
| 999 999 9638 | Wythenshawe |  |  |  |  |  |  | R0A1680914 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
